...
**Installation**: at the Julia REPL, run `using Pkg; Pkg.add("MultiSpacecraftAnalysis")`

**Documentation**: [![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://JuliaSpacePhysics.github.io/MultiSpacecraftAnalysis.jl/dev/)
